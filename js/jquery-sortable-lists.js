    ...
    $.fn.sortableLists = function (options) {
        ...
        var jQBody = $('body').css('position', 'relative'),
            ...
            defaults = {
                ...
                hintWrapperClass: '',
                hintWrapperCss: {
                    /* Description is below the defaults in this var section */ },
                baseClass: '',
                baseCss: {
                    'position': 'absolute',
        ...
        function startDrag(e, el, rEl) {
            ...
            state.cEl.xyOffsetDiff = {
                X: e.pageX - state.cEl.offset.left,
                Y: e.pageY - state.cEl.offset.top
            };
        ...
        function endDrag(e) {
            ...
            cEl.el.animate({
                    left: offset.left - state.cEl.mL,
                    top: offset.top - state.cEl.mT
                }, 250,
